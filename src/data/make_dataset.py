...
"""get_data definition does the following
...
def get_data(data_string):
    """
    Read the train/test dataset and merge with properties data set 
    and remove duplicate parcelid's in train
